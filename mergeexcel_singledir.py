...
path = "E:\\Prayog_IITB\\Test\\" #Change path to the directory where you have your input excel files
...
outputxlsx.to_excel("E:/Prayog_IITB/Test/Output.xlsx", index=False) #Give the path where you want to store merged output file
